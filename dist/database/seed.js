...
async function main() {
    ...
    for (const owner of owners) {
        const hashedPassword = await bcrypt_1.default.hash(owner.password, 12);
    ...
    // Default CHEF user
    const chefPassword = await bcrypt_1.default.hash('Chef123!', 12);
    await prisma.user.upsert({
    ...
    const packages = [
        {
            ...
            pricePerPerson: new client_1.Prisma.Decimal(39.95),
            sortOrder: 1,
        ...
        },
        {
            ...
            pricePerPerson: new client_1.Prisma.Decimal(54.95),
            sortOrder: 2,
        ...
        },
        {
            ...
            pricePerPerson: new client_1.Prisma.Decimal(74.95),
            sortOrder: 3,
    ...
    // ── Add-ons ────────────────────────────────────────────────────
    const addons = [
        { name: 'Filet Mignon Upgrade', pricePerPerson: new client_1.Prisma.Decimal(8.00), sortOrder: 1, description: 'Upgrade to premium Filet Mignon per guest' },
        { name: 'Lobster Upgrade', pricePerPerson: new client_1.Prisma.Decimal(10.00), sortOrder: 2, description: 'Add Lobster Ravioli or Lobster entrée per guest' },
        { name: 'Lamb Chop Upgrade', pricePerPerson: new client_1.Prisma.Decimal(7.00), sortOrder: 3, description: 'Add Grilled Lamb Chops per guest' },
        { name: 'Additional Entrée', pricePerPerson: new client_1.Prisma.Decimal(8.00), sortOrder: 4, description: 'Add one more entrée selection per guest' },
        { name: "Additional Hors d'oeuvre", pricePerPerson: new client_1.Prisma.Decimal(4.00), sortOrder: 5, description: "Add one more hors d'oeuvre per guest" },
        { name: 'Premium Dessert', pricePerPerson: new client_1.Prisma.Decimal(4.00), sortOrder: 6, description: 'Add a premium dessert selection per guest' },
    ];
